...
<link rel="stylesheet" href="./css/styles.css" type="text/css" />
 <script type="text/javascript">
     function updateNum(fid,txt,oldNum){
	  var newNum = txt.value;	 
	  if(confirm("你确定要修改吗？")){
		  location.href="cars?fid="+fid+"&num="+newNum+"&action=update";
	  }else{
		  txt.value = oldNum;
	  }	  
  } 
     function deleteProduct(fid){
	  if(confirm("确定要删除吗？")){
		  location.href="cars?action=delete&fid="+fid;
	  }
  }
  function dropProduct(cid){
	   if(confirm("确定要清空购物车吗？")){
		  location.href="cars?action=drop&cid="+cid;
	  }
  }
</script>
		...
		<table width="98%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" align="CENTER" cellpadding="2"
                   ...
                   <c:forEach items="${sessionScope.cars.items }" var="item">                                
					<tr bgcolor="#ffffff">
						...
						<td width="100" class="hh" align="center" height="22"><input type="text" value="${item.value.num }" onchange="updateNum(${item.key },this,${item.value.num })"/></td>
						<td width="116" class="bb" align="center" height="22"><font
							color="#000000">￥${item.value.sum }</font></td>
						<td width="116" class="bb" align="center" height="22"><font
						    color="#000000"><a href="javascript:deleteProduct(${item.key })">删除</a></font></td>
					</tr>
                 </c:forEach>
					<tr bgcolor="#dadada">
						...
						<td width="100" class="hh" height="22" align="center"><font
							color="#000000">-</font></td>
						<td width="116" class="bb" align="center" height="22"><font
							color="#000000">￥${sessionScope.cars.total } </font></td>
					</tr>
				...
				<table width="300" border="0" cellspacing="1" cellpadding="4"
					...
					<tr bgcolor="#dadada">
						<td height="10" align="center"><a href="javascript:dropProduct(${cars.car_id })"><font
							color="#000000">清空购物车</font></a></td>
						<td height="10" align="center"><a href="food"><font
							color="#000000">继续购物</font></a></td>
						<td height="10" align="center"><a href="cars?action=insert&uid=${sessionScope.user.uid }&cid=${sessionScope.cars.car_id } " ><font
