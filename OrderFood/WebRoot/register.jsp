...
<script language="javascript">
	function checkUserInfo() {
	  ...
	  var userPwd1 =document.loginForm.userPwd1.value;
		if (userName == "") {
			alert("用户名不能为空");
			return false;
		}
			...
			<TR vAlign=top>
				...
				<TD>
							...
							<TR>
								<TD>
									...
									<TABLE cellSpacing=1 cellPadding=1 width="100%" align=center
										...
										<TBODY>
											<TR bgColor=#dadada>
												<TD width="100%" align="center">我学我会网上点餐系统新用户请注册</TD>
											</TR>
										</TBODY>
									</TABLE> <BR></TD>
							</TR>
					...
					<form method="POST" name="loginForm"
						onSubmit="return checkUserInfo()" action="user?action=register">
						<table width="100%" border="0">
							...
							<tr>
								...
								<td valign="top"><input type="password" name="userPwd1"
									size="20" class="input">
								</td>
								<td></td>
							</tr>
