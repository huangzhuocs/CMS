...
<input type="hidden" value="${sessionScope.user.upwd }" id="upwd">
								...
								<TD>
									...
									<div>
										<form name="form1" method="post"
											...
											action="userMessage?action=updatepwd&uid=${sessionScope.user.uid }">
											<table width="563" height="255" border="0" cellpadding="0"
												cellspacing="0">
												<tr>
													<td colspan="3"><div align="center" class="STYLE2">用户密码修改</div>
													</td>
												</tr>
												<tr>
													<td width="204" height="38"><div align="right">原密码：</div>
													</td>
													<td width="210"><input type="password" name="pwd"
														id="pwd" class="input" style="width:170px;">
													</td>
													<td width="149">&nbsp;</td>
												</tr>
												<tr>
													<td height="40"><div align="right">新密码：</div>
													</td>
												...
												<tr>
													<td height="40"><div align="right">确认新密码：</div>
													</td>
												...
												<tr>
													<td colspan="3"><div align="center">
															<input type="submit" name="Submit" value="保 存"
																onclick="confirm('确定修改吗？')"> <input type="reset"
																value="重 置">
														</div>
													</td>
												</tr>
