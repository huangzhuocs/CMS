			...
			<TR vAlign=top>
												...
												<TD><br />
													<div id="menuDiv" style="width:80px; margin:0px auto;">
														<a
															...
															style="text-decoration: none">用户个人详细信息</a><br /> <br /> <a
															href="userMessage?action=show&uid=${sessionScope.user.uid }"
															style="text-decoration: none">修改用户信息</a> <br /> <br /> <a
															href="proscenium/updatePwd.jsp"
				...
				<TD align="center">
					<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
						<TBODY>
							<TR>
								<TD><IMG height=72 src="images/001.jpg" width=595>
								</TD>
							</TR>
						</TBODY>
					</TABLE>
								...
								<TD>
									...
									<div>
										<table width="563" height="255" border="0" cellpadding="0"
											cellspacing="0">
											<tr>
												<td colspan="3"><div align="center" class="STYLE2">用户个人信息</div>
												</td>
											</tr>
											<tr>
												<td width="204" height="38"><div align="right">姓名：</div>
												</td>
												<td width="210">${requestScope.userMessage.name }</td>
												<td width="149">&nbsp;</td>
											</tr>
											<tr>
												<td height="40"><div align="right">年龄：</div>
												</td>
												<td>${requestScope.userMessage.age }</td>
												<td>&nbsp;</td>
											</tr>
											<tr>
												<td height="40"><div align="right">性别：</div>
												</td>
												<td>${requestScope.userMessage.sex }</td>
												<td>&nbsp;</td>
											</tr>
											<tr>
												<td height="40"><div align="right">家庭地址：</div>
												</td>
												<td>${requestScope.userMessage.address }</td>
												<td>&nbsp;</td>
											</tr>
											<tr>
												<td height="38"><div align="right">手机/电话：</div>
												</td>
												<td>${requestScope.userMessage.mobile }</td>
												<td>&nbsp;</td>
											</tr>
											<tr>
												<td height="38"><div align="right">电子邮件：</div>
												</td>
												<td>${requestScope.userMessage.email }</td>
												<td>&nbsp;</td>
											</tr>
											<tr>
												<td><div align="right">喜欢菜品：</div>
												</td>
												<td>${requestScope.userMessage.likefood }</td>
												<td>&nbsp;</td>
											</tr>
											<tr>
