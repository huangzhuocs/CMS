											...
											<TR>
												<TD><br />
													<div id="menuDiv" style="width:80px; margin:0px auto;">
														...
														<a href="proscenium/updatePwd.jsp" style="text-decoration: none">修改密码</a>
														<br /> <br /> <a href="food">退出</a>
													</div></TD>
											</TR>
										</TBODY>
									</TABLE></TD>
								...
								<TD>
									...
									<div>
										<form name="form1" method="post"
											action="userMessage?action=add&uid=${sessionScope.user.uid }">
											<table width="563" height="255" border="0" cellpadding="0"
												cellspacing="0">
												<tr>
													<td colspan="3"><div align="center" class="STYLE2">详实个人信息</div>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td><input type="text" name="age" class="input"
														style="width:170px;">
													</td>
													<td>&nbsp;</td>
												</tr>
												...
												<tr>
													...
													<td><input type="text" name="address" class="input"
														style="width:170px;">
													</td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													...
													<td><input type="text" name="mobile" class="input"
														style="width:170px;">
													</td>
													<td>&nbsp;</td>
												</tr>
												...
												<tr>
													...
													<td><textarea cols="20" rows="3" name="likefood"></textarea>
													</td>
													<td>&nbsp;</td>
												</tr>
												<tr>
