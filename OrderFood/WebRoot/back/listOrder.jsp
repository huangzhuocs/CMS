									...
									<div>
										<form name="form1" method="post">
											...
											<table width="563" border="1" cellpadding="0" cellspacing="0">
												<tr>
													<td colspan="9"><div align="center" class="STYLE2">订单信息</div></td>
												</tr>
												<tr>
													<td width="50" height="38"><div align="center">订单编号</div></td>
													<td width="50" height="38"><div align="center">订餐人</div></td>
													<td width="70" height="38"><div align="center">订单详情</div></td>
													<td width="50" height="38"><div align="center">送餐地址</div></td>
													<td width="50" height="38"><div align="center">联系电话</div></td>
													<td width="50" height="38"><div align="center">订单附言</div></td>
													<td width="50" height="38"><div align="center">下单时间</div></td>
												</tr>

												<c:forEach items="${list }" var="p">
                      		<
                              <tr>
														<td height="38"><div align="center">${p.order_id}</div></td>
														<td height="38"><div align="center">${p.order_name}</div></td>
														<td height="38"><div align="center">
																<a style="color: red;"
																	href="/OrderFood/listFoodServlet?action=orderdetail&car_id=${p.car_id }">

																	查看详情 </a>
															</div></td>
														<td height="38"><div align="center">${p.order_address}</div></td>
														<td height="38"><div align="center">${p.order_mobile}</div></td>
														<td height="38"><div align="center">${p.postscript}</div></td>
														<td height="38"><div align="center">${p.order_time}</div></td>
													</tr>
													<tr></tr>
												</c:forEach>
