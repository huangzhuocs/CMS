								...
								<TD>
									...
									<table width="90%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td valign="top">
												<table width="98%" border="0" cellspacing="1"
													...
													<tr>
														<td height="21"><font color="#ff0000">价格：人民币${food.fprice }元</font><br>
															${food.fdescript }</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											...
											<td>
												<table width="145" border="0" cellspacing="1"
													cellpadding="0">
													<tr>
														<td align="center" width="70"><a href=#> <img
									...
									<P align=center>
										<IMG
											...
											height=294 alt="" hspace=0 src="images/${food.fpic }"
											width=350 border=0>
									</P>
									<P align=center>
										<FONT size=3>${food.fdescript }</FONT>
									</P> <br>
								</td>
							</tr>
					</table>
