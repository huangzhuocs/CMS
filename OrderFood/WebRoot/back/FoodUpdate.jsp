								...
								<TD>
									...
									<div>
										<form name="form1" method="post"
											action="/OrderFood/listFoodServlet?action=updatefood2">
											<table width="563" height="255" border="0" cellpadding="0"
												cellspacing="0">
												<tr>
													<td colspan="3"><div align="center" class="STYLE2">修改餐品</div></td>
												</tr>
												<tr>
													<td width="204" height="38"><div align="right">菜式名称：</div></td>
													<td width="210"><input type="text" name="food_name"
														class="input" value="${food.fname }" style="width:170px;"></td>
													<td width="149">&nbsp;</td>
												</tr>

												<tr>
													<td height="38"><div align="right">价格：</div></td>
													<td><input type="text" name="food_price" class="input"
														value="${food.fprice }" style="width:170px;"></td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td height="39"><div align="right">图片：</div></td>
													<td><input type="text" name="pic"
														value="${food.fpic }"></td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td><div align="right">菜式描述：</div></td>
													<td><textarea cols="20" rows="3" name="descript">
									     ${food.fdescript }
									</textarea></td>
													<td>&nbsp;</td>
												</tr>
